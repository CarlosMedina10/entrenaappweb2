        ...
        child: Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height:10),
                Text('Ya tienes activado el premium mensual en tu cuenta y estás inscrito en el sorteo',style: TextStyle(color:Color(0xff0A183D),fontSize:(isMobile || isTablet) ? 12 : 16,  ),),
                // SizedBox(height:10),
