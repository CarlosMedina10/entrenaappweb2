...
class Comprobando extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          ...
          return AlertDialog(
            ...
            content: new Text(
                "Ha ocurrido un error. Por favor, revisa tu conexión a internet y si el problema persiste contáctanos."),
            actions: <Widget>[
    ...
    return BlocProvider<ComprobandoBloc>(
        create: (context) => Comprobando,
        child: BlocListener<ComprobandoBloc, ComprobandoState>(
          listener: (context, state) {
            if (state is ErrorState) _showDialog();
          },
